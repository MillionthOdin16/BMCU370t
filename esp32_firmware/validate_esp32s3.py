...
def main():
    ...
    if all(results):
        ...
        print("\nCRITICAL: Use flash size override for ESP32-S3 N4R2 hardware:")
        print("esptool.py --chip esp32s3 --port /dev/ttyUSB0 --baud 921600 \\")
        print("  write_flash --flash_size 4MB --flash_mode dio --flash_freq 80m \\")
        print("  0x0 bootloader.bin 0x8000 partitions.bin 0x10000 firmware.bin")
        print("\nAlternative with auto-detection:")
        print("esptool.py --chip esp32s3 --port /dev/ttyUSB0 --baud 921600 \\")
        print("  write_flash --flash_size detect --flash_mode dio --flash_freq 80m \\")
        print("  0x0 bootloader.bin 0x8000 partitions.bin 0x10000 firmware.bin")
